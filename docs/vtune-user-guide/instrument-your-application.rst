...
with Intel® VTune™ Profiler, you need to add API calls in your code to
designate logical tasks. This will help you visualize the relationship
between tasks in your code, including when they start and end, relative
